...
----
	<bean id="inheritedTestBean" abstract="true"
			class="org.springframework.beans.BeanTests">
...
----
	...
	public class FactoryMethodComponent {
		...
		@Bean
		@Qualifier("public")
		public BeanTests publicInstance() {
			return new BeanTests("publicInstance");
		}
...
----
	...
	class FactoryMethodComponent {
		...
		@Bean
		@Qualifier("public")
		fun publicInstance() = BeanTests("publicInstance")
...
----
	...
	public class FactoryMethodComponent {
		...
		@Bean
		protected BeanTests protectedInstance(
				@Qualifier("public") BeanTests spouse,
				@Value("#{privateInstance.age}") String country) {
			BeanTests tb = new BeanTests("protectedInstance", 1);
			tb.setSpouse(spouse);
		...
		@Bean
		private BeanTests privateInstance() {
			return new BeanTests("privateInstance", i++);
		}

		@Bean
		@RequestScope
		public BeanTests requestScopedInstance() {
			return new BeanTests("requestScopedInstance", 3);
		}
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	...
	class FactoryMethodComponent {
		...
		protected fun protectedInstance(
				@Qualifier("public") spouse: BeanTests,
				@Value("#{privateInstance.age}") country: String) = BeanTests("protectedInstance", 1).apply {
			this.spouse = spouse
			this.country = country
		}

		@Bean
		private fun privateInstance() = BeanTests("privateInstance", i++)

		@Bean
		@RequestScope
		fun requestScopedInstance() = BeanTests("requestScopedInstance", 3)
	}
----
...
----
	...
	public class FactoryMethodComponent {
		...
		public BeanTests prototypeInstance(InjectionPoint injectionPoint) {
			return new BeanTests("prototypeInstance for " + injectionPoint.getMember());
		}
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	...
	class FactoryMethodComponent {
		...
		fun prototypeInstance(injectionPoint: InjectionPoint) =
				BeanTests("prototypeInstance for ${injectionPoint.member}")
	}
----
...
a call to `beanTest.getName()` returns `myTestBean`:
...
----
   ...
   public class AppConfig {
	   ...
	   @Bean
	   public BeanTests beanTest() {
		   BeanTests beanTest = new BeanTests();
		   beanTest.setName(env.getProperty("testbean.name"));
		   return beanTest;
	   }
   }
----
