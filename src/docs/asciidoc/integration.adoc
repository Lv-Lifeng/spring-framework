...
----
	<beans>
		...
		<bean id="exporter" class="org.springframework.jmx.export.MBeanExporter" lazy-init="false">
			<property name="beans">
				<map>
					<entry key="bean:name=testBean1" value-ref="beanTest"/>
				</map>
			</property>
		</bean>
		<bean id="beanTest" class="org.springframework.jmx.JmxTestBean">
...
With this configuration, the `beanTest` bean is exposed as an MBean under the
...
----
	<beans>
		...
		<bean id="beanTest" class="org.springframework.jmx.AnnotationTestBean">
			<property name="name" value="TEST"/>
			<property name="age" value="100"/>
		</bean>
	</beans>
...
----
	<beans>
		...
		<bean id="exporter" class="org.springframework.jmx.export.MBeanExporter">
			<property name="beans">
				<map>
					<entry key="bean:name=testBean5" value-ref="beanTest"/>
				</map>
			</property>
...
----
	<beans>
		...
		<bean id="exporter" class="org.springframework.jmx.export.MBeanExporter">
			<property name="beans">
				<map>
					<entry key="beanTest" value-ref="beanTest"/>
				</map>
			</property>
			<property name="namingStrategy" ref="namingStrategy"/>
		</bean>
		...
		<bean id="namingStrategy" class="org.springframework.jmx.export.naming.KeyNamingStrategy">
			<property name="mappings">
				<props>
					<prop key="beanTest">bean:name=testBean1</prop>
				</props>
			</property>
...
configuration, the `beanTest` bean is given an `ObjectName` of `bean:name=testBean1`,
...
----
	<bean id="proxy" class="org.springframework.jmx.access.MBeanProxyFactoryBean">
		<property name="objectName" value="bean:name=beanTest"/>
		<property name="proxyInterface" value="org.springframework.jmx.IJmxTestBean"/>
	</bean>
----

In the preceding example, you can see that a proxy is created for the MBean registered under the
`ObjectName` of `bean:name=beanTest`. The set of interfaces that the proxy implements
