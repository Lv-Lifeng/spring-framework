...
the approach to testing controllers that handle HTTP requests by using the Spring MVC com.lvlifeng.DemoTests
framework -- that is, without running a Servlet container but relying on the Spring Framework
to invoke the annotated controllers. As with Spring MVC com.lvlifeng.DemoTests, you have two
