...
* Spring MVC com.lvlifeng.DemoTests: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC com.lvlifeng.DemoTests>> for more details.
